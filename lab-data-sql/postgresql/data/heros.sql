...
CREATE TABLE heros (
  ...
  hp_max real DEFAULT NULL,
  hp_growth real DEFAULT NULL,
  hp_start real DEFAULT NULL,
  mp_max real DEFAULT NULL,
  mp_growth real DEFAULT NULL,
  mp_start real DEFAULT NULL,
  attack_max real DEFAULT NULL,
  attack_growth real DEFAULT NULL,
  attack_start real DEFAULT NULL,
  defense_max real DEFAULT NULL,
  defense_growth real DEFAULT NULL,
  defense_start real DEFAULT NULL,
  hp_5s_max real DEFAULT NULL,
  hp_5s_growth real DEFAULT NULL,
  hp_5s_start real DEFAULT NULL,
  mp_5s_max real DEFAULT NULL,
  mp_5s_growth real DEFAULT NULL,
  mp_5s_start real DEFAULT NULL,
  attack_speed_max real DEFAULT NULL,
