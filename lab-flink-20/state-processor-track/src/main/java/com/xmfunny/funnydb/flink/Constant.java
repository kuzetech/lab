...
public class Constant implements Serializable {
    ...
    /**
     * go-sdk 事件标识(目前直接写死,后续可根据规则进行调整)
     */
    public static final String GO_SDK_NAME = "go-sdk";

    /**
     * flink 衍生事件 #sdk_type 标识
     */
    public static final String SDK_TYPE_FLINK_DERIVE_NAME = "flink-derive";

    /**
     * flink 衍生事件 #sdk_version 默认标识
     */
    public static final String SDK_VERSION_FLINK_DERIVE_DEFAULT = "1.0.0";
     ...
     * 默认作业是否开启 EOS
     */
    public static final Boolean DEFAULT_KAFKA_EOS_ENABLE = false;

    /**
     * 默认作业开启 EOS 后事务超时时间(暂定60秒)
     */
    public static final long DEFAULT_KAFKA_EOS_TRANSACTION_TIMEOUT_MS_VALUE = TimeUnit.MILLISECONDS.convert(60, TimeUnit.SECONDS);
     ...
     * 默认 ingest 作业计算单元 slot 分组
     */
    public static final Boolean DEFAULT_INGEST_SKIP_WHEN_MISS_METADATA = false;
    ...
    /**
     * 默认 ingest 作业 api-v2 连接地址
     */
    public static final String DEFAULT_INGEST_V2_METADATA_SERVER_ENDPOINT = "http://localhost:9902";

    /**
     * 默认 ingest 作业 api-v2 连接用户名
     */
    public static final String DEFAULT_INGEST_V2_METADATA_SERVER_USERNAME = "turbine";

    /**
     * 默认 ingest 作业 api-v2 连接项目
     */
    public static final String DEFAULT_INGEST_V2_METADATA_SERVER_PROJECT = "funnydb";

    /**
     * 默认 ingest 作业 api-v2 连接配置正则
     */
    public static final String DEFAULT_INGEST_V2_METADATA_SERVER_CONFIG_REG = "ingest-metadata-.*";

    /**
     * 默认 ingest 作业 api-v2 连接更新间隔 秒
     */
    public static final Long DEFAULT_INGEST_V2_METADATA_SERVER_POLL_INTERVAL = 5L;
     ...
     * 默认Pulsar消费进度
     */
    public static final String DEFAULT_PULSAR_START_CURSOR_EARLIEST = PULSAR_START_CURSOR_EARLIEST;
    /**
     * id mapping 服务地址
     */
    public static final String IDMAPPING_SERVICE_ENDPOINT = "https://localhost:9000";


    /**
     * id mapping 服务访问token
     */
    public static final String IDMAPPING_SERVICE_TOKEN = "secret";

    /**
     * id mapping 服务支持的id名称
     */
    public static final String IDMAPPING_IDS = "#user_id,#account_id,#open_id,#device_id,#request_id,#click_id";

    /**
     * id mapping 请求批次大小
     */
    public static final int IDMAPPING_BATCH_SIZE = 50;

    /**
     * id mapping 请求批次超时时间
     */
    public static final long IDMAPPING_TIMEOUT = 30000;

    /**
     * id mapping 允许的app id
     */
    public static final String IDMAPPING_APP_LIST = "demo";

    /**
     * id mapping 异步IO 并行度
     */
    public static final Integer IDMAPPING_ASYNC_IO_BATCH_PARALLELISM = 4;
